...
func _relay_tests() -> void:
	...
	await _relay_pair_test("갈밭머리_하늬섬_손톱만한섬",
		"갈밭머리", "ga_gull", "전망대의 갈매기",
		"하늬섬", "do_kid", "자전거 탄 아이", "손톱만")
	...
	await _relay_pair_test("갈밭머리_꽃눈벌_계절",
		"갈밭머리", "cap_galbat", "갈대밭 쉼터 할머니",
		"꽃눈벌", "cap_kkot", "밭머리 쉼터 아주머니", "사시사철")
