...
func _build_meshes() -> void:
	...
	_set_sphere_mi(_left_eye_white, 0.055, 0.065, "#F5F5F5")
	...
	_set_sphere_mi(_right_eye_white, 0.055, 0.065, "#F5F5F5")
	...
	_set_sphere_mi(_left_eye_hl, 0.016, 0.020, "#FFFFFF")
	_left_eye_hl.position = $BodyPivot/HeadPivot/LeftEyeMesh.position + Vector3(-0.015, 0.018, 0.03)
	$BodyPivot/HeadPivot.add_child(_left_eye_hl)

	_right_eye_hl = MeshInstance3D.new()
	_set_sphere_mi(_right_eye_hl, 0.016, 0.020, "#FFFFFF")
	_right_eye_hl.position = $BodyPivot/HeadPivot/RightEyeMesh.position + Vector3(0.015, 0.018, 0.03)
