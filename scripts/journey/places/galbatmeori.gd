...
...............................................................
......gg..............................................gg.......
...ggggggggwwwwwww.................................gggggggg....
...ggggggggwwwwwww.................................gggggggg....
...ggggggggwwwwwww.................................gggggggg....
..ggggggggggwwwwww............dd..................gggggggggg...
..ggggggggggwwwwww............dd..................gggggggggg...
...gggggggg...................dd...................gggggggg....
...gggggggg...................dd...................gggggggg....
...gggggggg...................dd...................gggggggg....
......gg......................dd......................gg.......
..............................dd...............................
...
..gggg........................dd...............................
..gggg........................dd...............................
ggggggggdddddddddddddddddddddddddddddddddddddddddddddddddddd...
..gggg........................dd...............................
..gggg........................dd...............................
...gg.........................dd...............................
..............................dd...............................
...
func props() -> Array:
	return [
		...
		# ── 동쪽 카피바라 쉼터 ──────────────────────────────────────
		[54, 7, "shop", true],
		[57, 17, "guesthouse", true],
		[50, 5, "flower-pots", false],
		[57, 7, "fence", true],
		# ── 남쪽 전망대 ────────────────────────────────────────────
		[30, 25, "bench", true],
		[30, 31, "boulder", true],
		[36, 28, "beach-grass", false],
		[24, 28, "beach-grass", false],
		# ── 데크 곁 ────────────────────────────────────────────────
		[30, 7, "street-lamp", true],
		# ── 갈대 장터 (가게 곁) — 할머니의 좌판과 장독
		[50, 11, "stall", true],
		[48, 5, "jars", true],
		[54, 13, "flower-pots", false],
		# ── 전망대 쉼터 (갈매기의 자리)
		[35, 23, "bench", true],
		[27, 25, "pebbles", false],
		# ── 갈밭 속으로 들어가는 자리 ─────────────────────────────
		[17, 14, "beach-grass", false],
	]
...
func sleep_tile() -> Vector2i:
	return Vector2i(57, 17)


func depart_tile() -> Vector2i:
	return Vector2i(3, 17)

func wanderer_tile() -> Vector2i:
	return Vector2i(12, 13)
...
func on_built() -> void:
	...
	put_folk(Vector2i(51, 7), "capybara-c", "갈대밭 쉼터 할머니", "cap_galbat", [
	...
	put_folk(Vector2i(30, 7), "seagull", "전망대의 갈매기", "ga_gull", [
	...
	put_folk(Vector2i(36, 28), "deer", "갈대 사이의 고라니", "ga_deer", [
		["…"],
