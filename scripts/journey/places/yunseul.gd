...
## - **건물 발치에 작은 것을 붙인다.** 쿼스텔에 화분과 벤치, 가게에 화분,
...
func props() -> Array:
	return [
		...
		# 쿼스텔 몸(x2.9~6.1 · y6~12)에 안 걸리게 왼쪽 물가에 붙인다.
		[3, 5, "parasol", false],
		[1, 7, "parasol", false],
		...
		[8, 8, "pebbles", false],
		# 쿼장 뒷마당. 장작과 아이스박스가 붙어 있어야 살림처럼 보인다.
		[27, 8, "firewood", true],
		[29, 7, "icebox", false],
		...
		# 쿼스텔과 그 발치. 화분은 문(4,12) 왼쪽, 벤치는 오른쪽 모서리에.
...
func on_built() -> void:
	...
	put_folk(Vector2i(23, 11), "seal", "가게 할머니", "seal", [
