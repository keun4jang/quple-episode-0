...
func on_built() -> void:
	...
	put_folk(Vector2i(27, 11), "seagull", "갈매기 소년", "seagull", [
		...
		["나는 여기서 나고 자랐는데,", "가끔 저 배가 어디 가나 궁금해요.",
			"참, 이 근처에 빛이 머무는 자리가 세 군데 있어요.",
			"모래도 풀도 아닌, 딱 그 사이 같은 데서."],
		["오늘은 같이 좀 걸어요."],
	...
	put_folk(_nearest_walkable(Vector2i(21, 20)), "mongi", "몽이", "mongi", [
		[["몽이", "앗, 또 한 명 떨어졌네! 안녕, 나는 몽이야."],
			...
			["나", "…야근 대마왕?"],
			["몽이", "몬스터 옆에서 공격 버튼을 눌러 봐. 속성을 맞추면 효과가 굉장하지!"],
			["몽이", "구역마다 금관 쓴 우두머리가 있어. 쓰러뜨리면 꿈의 문이 열려."]],
		[["몽이", "물은 불을, 불은 나무를, 나무는 땅을 이겨."],
			["몽이", "땅은 바람을, 바람은 물을. 한 바퀴야."],
			["몽이", "LV 10 이 되면 캐릭터 창에서 직업을 골라. 전사, 마법사, 궁수, 도적!"]],
		[["몽이", "대마왕은 꽃눈벌 너머, 꿈속 잿마루 타워 꼭대기에 있대."],
			["몽이", "…그 탑, 어딘가 낯이 익지 않아?"]],
	], Vector2.LEFT)
