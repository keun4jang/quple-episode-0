...
func quest_zones() -> Array:
	return [
		["하늬섬:한바퀴", Vector2i(24, 12), 56.0],
		# 북쪽 현무암 언덕 꼭대기. 섬에서 제일 높은 자리다.
		["하늬섬:언덕", Vector2i(13, 5), 44.0],
	]
...
func on_built() -> void:
	...
	# 쿼장 좌판 앞
	put_folk(Vector2i(20, 12), "seal", "쿼귤 파는 할머니", "do_seal", [
		["쿼귤 하나 먹어 봐.", "여기 건 달아."],
		["바람이 세지? 늘 이래."],
	...
	put_folk(Vector2i(19, 8), "seagull", "자전거 탄 아이", "do_kid", [
		["섬 한 바퀴 십오 분이에요!"],
		["돌담 사이로 가면 더 빨라요."],
		["나는 여기서 태어났어요."],
		["같이 한 바퀴 돌래요?"],
