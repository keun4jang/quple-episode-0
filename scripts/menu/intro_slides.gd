...
## 재회와 평상. 인트로에서 쓰면 세 번째가 된다.
##
## 꿈결 대개편(`docs/redesign-dream.md` 2절): 야근하다 책상에 엎드려 잠드는
## 데까지만 보여 준다. 눈을 뜨는 곳은 다음 장면 - 어딘가 이상한 사무실이다.
...
const SLIDES := [
	["밤 열한 시.\n사무실에 남은 건 나뿐이었다.",
		...
		["cabinet", 150, 100, 4]]],
	["부장님 메신저가 울렸다.\n\"내일 아침까지 부탁해요.\"",
		[["desk", 0, 40, 7], ["office-chair", 0, 130, 7]]],
	["모니터 구석에 켜 둔 옛날 게임 하나.\n꿈결 온라인.",
		[["office-window", 0, 0, 9]]],
	["…잠깐만, 눈 좀 붙이자.",
		[["hero", 0, 0, 9]]],
]
