...
const ITEMS := {
	...
	"m-blaze": {"name": "화르륵 조각", "kind": "shade", "guard": "blaze",
		"desc": "꺼질 듯 꺼지지 않는 불씨."},
	"m-drop_king": {"name": "물방울 대왕의 왕관 조각", "kind": "shade", "guard": "drop_king",
		"desc": "윤슬의 꿈의 문을 연 증표."},
	"m-dokkaebi": {"name": "불꽃 도깨비의 뿔 조각", "kind": "shade", "guard": "dokkaebi",
		"desc": "만지면 아직도 따끔하다."},
	"m-golem": {"name": "바위 거인의 돌 심장", "kind": "shade", "guard": "golem",
		"desc": "쿵, 쿵. 아주 천천히 뛴다."},
	"m-gull": {"name": "태풍 갈매기의 깃털", "kind": "shade", "guard": "gull",
		"desc": "들면 바람이 인다."},
	"m-carp": {"name": "잉어왕의 비늘", "kind": "shade", "guard": "carp",
		"desc": "물결무늬가 빙글빙글 돈다."},
	"m-lotus": {"name": "연꽃 정령의 꽃잎", "kind": "shade", "guard": "lotus",
		"desc": "시들지 않는다. 꿈이라서."},
	"m-thorn_queen": {"name": "가시덩굴 여왕의 관", "kind": "shade", "guard": "thorn_queen",
		"desc": "가시가 다 빠져 이제 쓸 수 있다."},
	"m-mole_king": {"name": "두더지왕의 삽", "kind": "shade", "guard": "mole_king",
		"desc": "작지만 어디든 판다."},
	"m-deer": {"name": "화염 꽃사슴의 뿔", "kind": "shade", "guard": "deer",
		"desc": "꿈이 금 간 날의 불빛이 남았다."},
	"m-paper": {"name": "결재 서류 한 장", "kind": "shade", "guard": "paper",
		"desc": "도장이 찍혀 있다. 반려."},
	"m-memo": {"name": "회의록 쪽지", "kind": "shade", "guard": "memo",
		"desc": "결론: 다음 회의에서 다시 논의."},
	"m-vending": {"name": "식은 커피 캔", "kind": "shade", "guard": "vending",
		"desc": "아직 따지 않았다."},
